...
@MappedSuperclass // lớp con kế thừa được ánh xạ các thuộc tính vào entity nhưng không tạo bảng riêng
public abstract class BaseEntity { // lớp abstract
  ...
  @Column(name = "created_at", nullable = false) // nullable là không cho phép cột được tạo trong table là giá trị null
  ...
  protected void prePersist() {
    if (this.createdAt == null) createdAt = Instant.now().toEpochMilli(); // đổi thời gian hiện tại thành milliseconds
